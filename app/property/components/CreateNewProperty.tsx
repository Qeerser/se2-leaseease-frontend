    ...
    return (
        <div className="flex w-[32.5rem] h-[calc(100vh-4rem)] p-0 flex-col items-start absolute right-0 bottom-0 border-l border-slate-300 bg-white shadow-[0px_4px_6px_-4px_rgba(0,_0,_0,_0.10),_0px_10px_15px_-3px_rgba(0,_0,_0,_0.10)]  overflow-y-auto">
                ...
                <div className="flex flex-col items-start gap-[16px] self-stretch">
                    ...
                    <div className="flex flex-col items-start gap-[4px] self-stretch">
                        <div className="flex items-start gap-[10px] self-stretch">
                            <div className="text-slate-700 text-xs font-medium leading-[16px]" style={{ fontFamily: 'Inter' }}>
                                Image*
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col items-start gap-[4px] self-stretch">
                        ...
                        <div className="flex p-[8px] items-center gap-[10px] self-stretch rounded-[6px] border border-slate-200">
                            <input className="text-base font-normal leading-[24px] w-full outline-none" style={{ fontFamily: 'Inter' }} placeholder="Property Name" />
                        </div>
                    </div>
                    ...
                    <div className="flex h-[144px] flex-col items-start gap-[4px] self-stretch">
                        ...
                        <div className="flex p-[8px] items-start gap-[10px] flex-1 self-stretch rounded-[6px] border border-slate-200">
                            <textarea className="text-base font-normal leading-[24px] w-full h-full outline-none resize-none" style={{ fontFamily: 'Inter' }} placeholder="Property Location" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-start gap-[4px] self-stretch">
                        ...
                        <div className="flex items-center gap-[4px] self-stretch">
                            <div className="flex p-[8px] items-center gap-[10px] flex-1 rounded-[6px] border border-slate-200">
                                <input type="number" className="text-base font-normal leading-[24px] w-full outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" style={{ fontFamily: 'Inter' }} placeholder="eg. 100.00" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-start gap-[4px] self-stretch">
                        ...
                        <div className="flex p-[8px] items-center gap-[10px] self-stretch rounded-[6px] border border-slate-200">
                            <input type="number" className="w-full text-base font-normal leading-[24px] outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" style={{ fontFamily: 'Inter' }} placeholder="eg. 1,000.00" />
                        </div>
            ...
            <div className="flex p-[16px] justify-center items-center gap-3 self-stretch border-t border-slate-300 fixed bottom-0 right-0 w-[32.5rem] bg-white">
                ...
                <button className="flex p-[12px] justify-center items-center gap-2 flex-1 rounded-[6px] bg-blue-900 text-white">
                    Create Property
                </button>
            </div>
            {/* </div> */}
