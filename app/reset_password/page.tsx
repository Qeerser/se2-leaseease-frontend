                ...
                <div className="flex flex-col items-center gap-4 self-stretch">
                    <div className="flex flex-col items-start gap-1 self-stretch">
                        ...
                        <div className="flex items-center gap-[10px] self-stretch p-2 rounded-md border border-[#E2E8F0]">
                            <input placeholder="Enter your new password" className="text-base font-normal leading-6 text-[#334155] font-inter outline-none w-full"/>
                        </div>
                    </div>
                    <div className="flex flex-col items-start gap-1 self-stretch">
                    <div className="flex items-start gap-[10px] self-stretch">
                        ...
                        <div className="flex items-center gap-[10px] self-stretch p-2 rounded-md border border-[#E2E8F0]">
                            <input placeholder="Confirm your new password" className="text-base font-normal leading-6 text-[#334155] font-inter outline-none w-full"/>
                        </div>
                    </div>
