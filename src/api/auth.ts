...
export const register = async (id:number, name: string, address: string,email: string, password: string, role:string) => {
  return await apiClient.post("/auth/register", { id, name, address, email, password, role });
};
